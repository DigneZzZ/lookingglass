            ...
            <div class="card animate-slide-up delay-150">
                <div class="p-4 sm:p-6">
                    <div class="flex items-center gap-2 mb-4 sm:mb-6">
                        ...
                        <?php if (!empty($netInfo['bgp_tools'])): ?>
                        <a href="<?php echo htmlspecialchars($netInfo['bgp_tools']) ?>" target="_blank" class="ml-auto btn btn-outline h-7 px-2 text-xs" title="View full BGP details">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                            </svg>
                            bgp.tools
                        ...
                        <div class="space-y-2 sm:col-span-1 lg:col-span-2">
                            ...
                            <div class="px-3 py-2 rounded-lg bg-muted/50 border border-border/50">
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <a href="https://bgp.tools/as/<?php echo htmlspecialchars(str_replace('AS', '', $upstream['asn'])) ?>" 
                                       target="_blank"
                    ...
                    <div class="mt-3 pt-3 border-t border-border/30 flex justify-end">
                        <span class="text-[10px] text-muted-foreground/60" title="Data from RIPE Stat API">
